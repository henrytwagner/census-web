export const Header = () => {
    return (
        <header className="flex p-2 justify-between items-center bg-gray-200">
            ...
            <div className="flex h-6 p-1 justify-center items-center flex-shrink-0 w-90 bg-gray-700 rounded-full gap-1.5">
                <p className="text-xs not-italic font-normal">􀊫</p>
                <p className="text-xs not-italic font-normal">Search</p>
            </div>
            <div className="flex w-[300px] justify-end items-center gap-2.5 flex-shrink-0">
                <p className="text-xl not-italic font-normal text-black">􀊫</p>
                <div className="flex w-8 h-8 flex-col justify-center items-center flex-shrink-0 rounded-full bg-blue-700"></div>
            </div>
        </header>
    );
}
